<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="header.ascx.cs" Inherits="ADMIN_PANEL.header" %>
...
<div class="Lmenubar">
            ...
            <img alt="HOPE LOGO" class="auto-style1" src="Pictures/LOGO.png" />
            </asp:HyperLink>
            </div>
            <div class="Lheader-seperation">
            <img src="Pictures/piclogo.png" /><asp:Button ID="Login" runat="server" CssClass="Lbuttons" OnClick="Button4_Click" Text="Name" />
        </div>
    </div>