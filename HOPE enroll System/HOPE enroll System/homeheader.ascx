<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="homeheader.ascx.cs" Inherits="HOPE_enroll_System.homeheader" %>
...
<div class="Lmenubar">
            ...
            <img src="Images/2815428.png" /><asp:Button ID="Login" runat="server" CssClass="Lbuttons" OnClick="Button4_Click" Text="Name" />
        </div>
    </div>